<p style={text-align:center; font-size:3rem;}>Aplikasi pengelolaan buku</p>
...
Jangan lupa sebelum menjalankan aplikasi, lakukan perintah "composer install" dan "npm install" pada terminal. Dan jangan lupa ubah koneksi database pada file .env anda
